...
public class SeekBarPressure extends View {
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        mThumbLow = getResources().getDrawable(R.mipmap.range, null);
        mThumbHigh = getResources().getDrawable(R.mipmap.range, null);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(defaultScreenLow != 0) {
            ...
            mOffsetLow = formatInt(defaultScreenLow / 37 * (mDistance)) + mThumbWidth / 2;
        }

        if(defaultScreenHigh != 100) {

            mOffsetHigh = formatInt(defaultScreenHigh / 37 * (mDistance)) + mThumbWidth / 2;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //当前滑块刻度
        double progressLow = formatInt(((mOffsetLow - mThumbWidth / 2) * 37 / mDistance)+18);
        double progressHigh = formatInt(((mOffsetHigh - mThumbWidth / 2) * 37 / mDistance)+18);
